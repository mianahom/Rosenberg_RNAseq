...
distal_ddsHTSeq$uroE_bin <- factor(distal_ddsHTSeq$uroE_bin, levels = levels)
distal_ddsHTSeq$uroE_bin
```
### Get results
```{r}
...
```{r}
res1_dist <-results(distal_dds, name="uroE_bin_high_vs_zero")
res2_dist <-results(distal_dds, name="uroE_bin_med_vs_zero")
res3_dist <-results(distal_dds, name="uroE_bin_low_vs_zero")
res4_dist <-results(distal_dds, contrast=list(c("uroE_bin_high_vs_zero"),c("uroE_bin_low_vs_zero")))
res5_dist <-results(distal_dds, contrast=list(c("uroE_bin_med_vs_zero"),c("uroE_bin_low_vs_zero")))
res6_dist <-results(distal_dds, contrast=list(c("uroE_bin_high_vs_zero"),c("uroE_bin_med_vs_zero")))
...
```{r}
levels <- c("zero","low","med","high")
proximal_ddsHTSeq$uroE_bin <- factor(proximal_ddsHTSeq$uroE_bin, levels = levels)
proximal_ddsHTSeq$uroE_bin
```
### Get results
```{r}
...
```{r}
res1_prox <-results(proximal_dds, name="uroE_bin_high_vs_zero")
res2_prox <-results(proximal_dds, name="uroE_bin_med_vs_zero")
res3_prox <-results(proximal_dds, name="uroE_bin_low_vs_zero")
res4_prox <-results(proximal_dds, contrast=list(c("uroE_bin_high_vs_zero"),c("uroE_bin_low_vs_zero")))
res5_prox <-results(proximal_dds, contrast=list(c("uroE_bin_med_vs_zero"),c("uroE_bin_low_vs_zero")))
res6_prox <-results(proximal_dds, contrast=list(c("uroE_bin_high_vs_zero"),c("uroE_bin_med_vs_zero")))
